...
set :repository,  'git@codepia.co.cc:postclip.git'
...
role :web, 'codepia.co.cc'                          # Your HTTP server, Apache/etc
role :app, 'codepia.co.cc'                          # This may be the same as your `Web` server
role :db,  'codepia.co.cc', :primary => true # This is where Rails migrations will run
